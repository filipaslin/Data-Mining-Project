...
explict_real=pd.read_csv(directory + "Data/explicit_data/gossipcop_real_all_user_explicit_features.csv")
explict_fake=pd.read_csv(directory + "Data/explicit_data/gossipcop_fake_all_user_explicit_features.csv")
with open(directory + "Data/m3_data_out/gossipcop_real_m3_all_user_info.pkl", 'rb') as pickle_file:
    m3_real=pickle.load(pickle_file)
with open(directory + "Data/m3_data_out/gossipcop_fake_m3_all_user_info.pkl", 'rb') as pickle_file:
...
f = open(directory + "Data/all_users_attribute.pkl","wb")
